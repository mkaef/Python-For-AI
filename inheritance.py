# INHERITANCE
"""
Inheritance is an advanced Python concept 
that you probably won’t use when starting out.
 Most beginner programs work perfectly fine without it. 
 However, as your projects grow, inheritance can make your code 
 much cleaner by avoiding repetition.
"""

# What is inheritance?
"""
Inheritance lets you create new classes based on existing ones. 
The new class (child) gets everything from the parent class, 
